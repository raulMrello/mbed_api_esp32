...
public:
    ...
    */
    ...
    enum State {
		...
		Waiting,			/// A�adido por compatibilidad con FreeRTOS
    ...
    */
    ...
    /**
     * Activa nivel de depuraci�n
     * @param level Nivel de depuraci�n
     */
...
protected:
    ...
    uint32_t 			_stack_size;	/// Tama�o del stack asignado
