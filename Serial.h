 ...
 *      Author: raulMrello
 *
 *	Portabilidad del driver RawSerial en un nuevo m�dulo denominado Serial compatible con ESP-IDF y la
...
public:
	 ...
	 *  @param eof Caracter de f�n de trama
	 *  @param uart_num UART
    ...
    /**
     * Chequea si el componente est� habilitado y listo para su ejecuci�n
     ...
     * @param format Formato y lista de par�metros
     * @return
     */
     ...
     *  @param timeout_us Tiempo a esperar en millis hasta que haya datos en el buffer de recepci�n
    ...
    /** setDebugMode()
     *  Habilita o Deshabilita el modo de depuraci�n
     *  @param endis True Habilita el modo depuraci�n, False cancela el modo depuraci�n
     */
...
protected:
    ...
    /** Tarea de gesti�n en Freertos
     */
    void task();


    /** M�ximo n�mero acumulado de eventos en la tarea asociada a la UART */
