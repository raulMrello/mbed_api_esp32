...
public:
	...
	/** Configuraci�n por defecto del componente */
    enum Parity {
        None = 0,
        Odd,
        Even
     ...
     *  @param uart_num Incluyo este par�metro para seleccionar la UART
     *  @param priority Prioridad del hilo de contol
     *  @param stack_size Tama�o del stack del hilo de control
     *
     *  @note
...
protected:
    ...
    /** Tama�o por defecto de la FIFO de recepci�n */
