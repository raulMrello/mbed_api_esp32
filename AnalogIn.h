 ...
 *	NOTAS:
 *		ESP32 dispone de dos ADC dependiendo de la fuente anal�gica:
 *		ADC1 utiliza entradas del sistema como la tensi�n Vdd, sensores cap, etc...
 *		ADC2 utiliza pines GPIO, por lo tanto en funci�n de la entrada seleccionada se utilizar� uno u otro ADC.
 *
 */
